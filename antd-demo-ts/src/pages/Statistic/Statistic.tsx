      ...
      <div className='today-wrap'>
        ...
        <div className='today-statistic-wrap'>
          ...
          <div className='today-audiocall'>
            ...
            <p className='statistic-description'>Процент правильных:{`${((audioCallRight + AudioCallWron) === 0 ? 0 : audioCallRight / (audioCallRight + AudioCallWron)).toFixed(2)}%`}</p>
